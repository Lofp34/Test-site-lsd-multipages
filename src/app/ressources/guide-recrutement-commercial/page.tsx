      ...
      <section className="py-20 bg-white
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-2xl p-8 text-center border border-red-500/20">
            ...
            <div className="bg-white rounded-2xl p-8 text-center border border-orange-500/20">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <div className="bg-mint-green/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-ink mb-2">Motivation (0-5 points)</h4>
                ...
                <div className="bg-mint-green/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-ink mb-2">Communication (0-5 points)</h4>
                  <ul className="text-sm text-gray-anthracite space-y-1">
                ...
                <div className="bg-mint-green/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-ink mb-2">Expérience (0-5 points)</h4>
                  <ul className="text-sm text-gray-anthracite space-y-1">
            ...
            <div className="bg-white rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <div className="bg-mint-green/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-ink mb-2">Compétences Vente (0-25 points)</h4>
                  <ul className="text-sm text-gray-anthracite space-y-1">
                ...
                <div className="bg-mint-green/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-ink mb-2">Soft Skills (0-20 points)</h4>
                  <ul className="text-sm text-gray-anthracite space-y-1">
                ...
                <div className="bg-mint-green/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-ink mb-2">Fit Culturel (0-20 points)</h4>
                  <ul className="text-sm text-gray-anthracite space-y-1">
                ...
                <div className="bg-mint-green/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-ink mb-2">Potentiel (0-20 points)</h4>
                  <ul className="text-sm text-gray-anthracite space-y-1">
                ...
                <div className="bg-mint-green/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-ink mb-2">Mise en Situation (0-15 points)</h4>
                  <ul className="text-sm text-gray-anthracite space-y-1">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8">
              ...
              <div className="space-y-3 text-sm text-gray-anthracite
