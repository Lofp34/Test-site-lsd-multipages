...
const book = mindsetPerformanceCategory.books.find(b => b.slug === 'grit-power-passion-perseverance');

if (!book) {
  throw new Error('Livre Grit non trouvé dans les données');
}
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'persévérance commerciale',
    'passion persévérance',
    'ténacité prospection',
    'résilience vente',
    ...
    <main className="relative bg-gradient-to-br from-orange-soft via-orange-soft/10 to-primary-bg min-h-screen pt-24 pb-16 overflow-hidden">
      ...
      <CategoryBreadcrumb 
        items={[
          ...
          { label: bookData.title, href: `/ressources/meilleurs-livres/mindset-performance/grit-power-passion-perseverance`, current: true }
        ]}
