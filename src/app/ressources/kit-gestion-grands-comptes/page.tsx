          ...
          <div className="bg-slate-50 rounded-2xl p-8 mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-4 mt-8">
              <div className="text-center p-4 bg-white rounded-xl">
                ...
                <p className="text-sm text-gray-anthracite de croissance d'un grand compte</p>
              </div>
              <div className="text-center p-4 bg-white rounded-xl">
                <div className="text-3xl font-bold text-mint-green mb-2">65%</div>
                <p className="text-sm text-gray-anthracite probabilité de vente supplémentaire</p>
              </div>
              <div className="text-center p-4 bg-white rounded-xl">
                <div className="text-3xl font-bold text-mint-green mb-2">25%</div>
                <p className="text-sm text-gray-anthracite marge supplémentaire en moyenne</p>
              </div>
            </div>
          </div>
        </section>
