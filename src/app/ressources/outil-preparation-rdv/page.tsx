          ...
          <div className="bg-slate-50 rounded-2xl p-8 mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-4 mt-8">
              <div className="text-center p-4 bg-white rounded-xl">
                ...
                <p className="text-sm text-gray-anthracite RDV ratés sont dus à une mauvaise préparation</p>
              </div>
              <div className="text-center p-4 bg-white rounded-xl">
                <div className="text-3xl font-bold text-mint-green mb-2">3x</div>
                <p className="text-sm text-gray-anthracite de chances de conclure avec une bonne préparation</p>
              </div>
              <div className="text-center p-4 bg-white rounded-xl">
                <div className="text-3xl font-bold text-mint-green mb-2">30min</div>
                <p className="text-sm text-gray-anthracite préparation suffisent pour faire la différence</p>
              </div>
            </div>
          </div>
        </section>
