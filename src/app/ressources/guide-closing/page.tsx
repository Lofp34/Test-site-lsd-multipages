      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-blue-ink dark:text-primary-bg">Confiance Absolue</h4>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-mint-green mr-3 mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-blue-ink dark:text-primary-bg">Détachement du Résultat</h4>
                      <p className="text-sm text-gray-anthracite dark:text-primary-bg/80">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-mint-green mr-3 mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-blue-ink dark:text-primary-bg">Focus sur la Valeur</h4>
                      <p className="text-sm text-gray-anthracite dark:text-primary-bg/80">
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-mint-green mr-3 mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-blue-ink dark:text-primary-bg">Patience Active</h4>
                      <p className="text-sm text-gray-anthracite dark:text-primary-bg/80">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-mint-green/10 to-blue-ink/10 rounded-xl p-6">
              ...
              <div className="bg-white dark:bg-gray-anthracite/20 rounded-lg p-4">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-gray-anthracite/10 rounded-xl p-6 border border-slate-200 dark:border-gray-700">
              <h3 className="text-lg font-title font-semibold text-blue-ink dark:text-primary-bg mb-4">
                🗣️ Signaux Verbaux
              </h3>
