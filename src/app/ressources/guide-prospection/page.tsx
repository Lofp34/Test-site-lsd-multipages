          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-6 border border-slate-200
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-title font-semibold text-blue-ink Téléphonique</h3>
              </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-slate-200
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-title font-semibold text-blue-ink Marketing</h3>
              </div>
              <p className="text-gray-anthracite mb-4">
            ...
            <div className="bg-white rounded-xl p-6 border border-slate-200
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-title font-semibold text-blue-ink Networking</h3>
              </div>
              <p className="text-gray-anthracite mb-4">
