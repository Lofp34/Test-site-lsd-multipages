          ...
          <div className="space-y-4">
            ...
            <div className="border-l-4 border-emerald-500 pl-6 space-y-8">
              <div>
                ...
                <p className="text-gray-anthracite">Après l'appel, la première question à poser est toujours : "Comment as-tu trouvé que ça s'est passé ?". Laissez le commercial analyser sa propre performance. C'est la première étape de la prise de conscience.</p>
              </div>
              <div>
                <h4 className="font-title font-bold text-xl text-blue-ink mb-2">2. Le Feedback Positif Spécifique</h4>
                <p className="text-gray-anthracite">Commencez TOUJOURS par ce qui a bien fonctionné. Soyez précis. "J'ai beaucoup aimé la façon dont tu as reformulé son besoin à la 5ème minute" est plus puissant que "Bon appel".</p>
              </div>
              <div>
                <h4 className="font-title font-bold text-xl text-blue-ink mb-2">3. L'Axe de Progression Unique</h4>
                <p className="text-gray-anthracite">Choisissez UN seul point d'amélioration, le plus impactant. "Pour le prochain appel, si tu es d'accord, je te propose de te concentrer sur le fait de poser la question du budget un peu plus tôt. Qu'en penses-tu ?"</p>
              </div>
            </div>
          </div>
        </section>
