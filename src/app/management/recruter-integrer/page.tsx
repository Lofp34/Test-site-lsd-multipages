        ...
        <section className="mb-16">
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-gray-anthracite/10 rounded-xl p-6 border border-slate-200 dark:border-gray-700">
              ...
              <p className="text-gray-anthracite dark:text-primary-bg/80 mb-4">Avant de chercher, sachez ce que vous voulez trouver. La scorecard définit le succès pour le poste :</p>
            ...
            <div className="bg-white dark:bg-gray-anthracite/10 rounded-xl p-6 border border-slate-200 dark:border-gray-700">
              ...
              <p className="text-gray-anthracite dark:text-primary-bg/80 mb-4">L'expérience c'est bien, mais les savoir-être (soft skills) font la différence sur le long terme. Cherchez activement :</p>
              <div className="grid md:grid-cols-3 gap-4 text-center">
                <div className="bg-slate-50 dark:bg-gray-anthracite/20 p-4 rounded-lg"><strong>Curiosité</strong><p className="text-sm">Veut sincèrement comprendre le problème du client.</p></div>
                <div className="bg-slate-50 dark:bg-gray-anthracite/20 p-4 rounded-lg"><strong>Résilience</strong><p className="text-sm">Ne se décourage pas face au "non".</p></div>
                <div className="bg-slate-50 dark:bg-gray-anthracite/20 p-4 rounded-lg"><strong>Coachabilité</strong><p className="text-sm">Est ouvert au feedback et cherche à progresser.</p></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            ...
            <div className="border-l-4 border-mint-green pl-6 space-y-8">
              <div>
                <h4 className="font-title font-bold text-xl text-blue-ink dark:text-primary-bg mb-2">Jours 1-30 : Immersion & Premières Bases</h4>
              ...
              <div>
                <h4 className="font-title font-bold text-xl text-blue-ink dark:text-primary-bg mb-2">Jours 31-60 : Action & Premiers Feedbacks</h4>
                <ul className="space-y-2 text-gray-anthracite dark:text-primary-bg/80">
              ...
              <div>
                <h4 className="font-title font-bold text-xl text-blue-ink dark:text-primary-bg mb-2">Jours 61-90 : Autonomie & Performance</h4>
                <ul className="space-y-2 text-gray-anthracite dark:text-primary-bg/80">
