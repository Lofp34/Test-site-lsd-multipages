      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-gray-anthracite/10 rounded-xl p-6 border border-slate-200 dark:border-gray-700">
              <h3 className="text-xl font-title font-semibold text-blue-ink dark:text-primary-bg mb-2">Autonomie</h3>
              <p className="text-gray-anthracite dark:text-primary-bg/80">Donner la liberté sur le "comment" tout en étant clair sur le "quoi" et le "pourquoi". Laisser les commerciaux s'approprier leur secteur et leurs méthodes, dans le respect du cadre défini.</p>
            </div>
            <div className="bg-white dark:bg-gray-anthracite/10 rounded-xl p-6 border border-slate-200 dark:border-gray-700">
              <h3 className="text-xl font-title font-semibold text-blue-ink dark:text-primary-bg mb-2">Maîtrise</h3>
              <p className="text-gray-anthracite dark:text-primary-bg/80">Aider chaque membre de l'équipe à progresser et à devenir meilleur dans son art. Le sentiment de compétence est un moteur puissant. Cela passe par le coaching et la formation continue.</p>
            </div>
            <div className="bg-white dark:bg-gray-anthracite/10 rounded-xl p-6 border border-slate-200 dark:border-gray-700">
              <h3 className="text-xl font-title font-semibold text-blue-ink dark:text-primary-bg mb-2">Finalité</h3>
              <p className="text-gray-anthracite dark:text-primary-bg/80">Connecter le travail quotidien à une mission plus grande. Montrer l'impact du travail de l'équipe sur les clients et sur le succès de l'entreprise. Célébrer les victoires collectives.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white dark:bg-gray-anthracite/10 rounded-xl p-6 border border-slate-200 dark:border-gray-700">
              <ul className="space-y-4 text-gray-anthracite dark:text-primary-bg/80">
                <li className="flex items-start">
                  <Shield className="w-6 h-6 text-amber-500 mr-4 mt-0.5 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-blue-ink dark:text-primary-bg">Valoriser la Transparence, pas la Faute</h4>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-ink dark:text-primary-bg">Célébrer les Comportements, pas Uniquement les Résultats</h4>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-ink dark:text-primary-bg">Mener des Rituels d'Équipe Efficaces</h4>
