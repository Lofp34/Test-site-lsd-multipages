          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 border border-slate-200">
              ...
              <p className="text-gray-anthracite">
                Donnez la liberté sur le "comment" tout en étant clair sur le "quoi" et le "pourquoi". Laissez les commerciaux s'approprier leur secteur et leurs méthodes, dans le respect du cadre défini.
              </p>
            </div>
            <div className="bg-white rounded-xl p-6 border border-slate-200">
              <h3 className="text-xl font-title font-semibold text-blue-ink mb-2">Maîtrise</h3>
              <p className="text-gray-anthracite">
                Aidez chaque membre de l'équipe à progresser et à devenir meilleur dans son art. Le sentiment de compétence est un moteur puissant. Cela passe par le coaching et la formation continue.
              </p>
            </div>
            <div className="bg-white rounded-xl p-6 border border-slate-200">
              <h3 className="text-xl font-title font-semibold text-blue-ink mb-2">Finalité</h3>
              <p className="text-gray-anthracite">
                Reliez le travail quotidien à une mission plus grande. Montrez l'impact du travail de l'équipe sur les clients et sur le succès de l'entreprise. Célébrez les victoires collectives.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-white rounded-xl p-6 border border-slate-200">
              <ul className="space-y-4 text-gray-anthracite">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-ink">Créer des Rituels d'Équipe Efficaces</h4>
