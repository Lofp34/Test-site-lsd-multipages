        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 border border-slate-200
              ...
              <p className="text-gray-anthracite la liberté sur le "comment" tout en étant clair sur le "quoi" et le "pourquoi". Laisser les commerciaux s'approprier leur secteur et leurs méthodes, dans le respect du cadre défini.</p>
            </div>
            <div className="bg-white rounded-xl p-6 border border-slate-200
              <h3 className="text-xl font-title font-semibold text-blue-ink mb-2">Maîtrise</h3>
              <p className="text-gray-anthracite chaque membre de l'équipe à progresser et à devenir meilleur dans son art. Le sentiment de compétence est un moteur puissant. Cela passe par le coaching et la formation continue.</p>
            </div>
            <div className="bg-white rounded-xl p-6 border border-slate-200
              <h3 className="text-xl font-title font-semibold text-blue-ink mb-2">Finalité</h3>
              <p className="text-gray-anthracite le travail quotidien à une mission plus grande. Montrer l'impact du travail de l'équipe sur les clients et sur le succès de l'entreprise. Célébrer les victoires collectives.</p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-white rounded-xl p-6 border border-slate-200
              <ul className="space-y-4 text-gray-anthracite
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-ink la Transparence, pas la Faute</h4>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-ink les Comportements, pas Uniquement les Résultats</h4>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-ink des Rituels d'Équipe Efficaces</h4>
