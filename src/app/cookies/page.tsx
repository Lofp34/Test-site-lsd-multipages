      ...
      <main className="bg-primary-bg text-gray-dark py-24 sm:py-32">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="prose prose-lg mx-auto text-left
            ...
            <h2 className="text-2xl font-title font-semibold text-blue-ink mt-12 mb-4">Qu'est-ce qu'un cookie ?</h2>
            <p>
            ...
            <h2 className="text-2xl font-title font-semibold text-blue-ink mt-12 mb-4">Quels cookies utilisons-nous ?</h2>
            <p>
            ...
            <h2 className="text-2xl font-title font-semibold text-blue-ink mt-12 mb-4">Accepter ou refuser les cookies</h2>
            <p>
            ...
            <h3 className="text-xl font-title font-semibold text-blue-ink mt-8 mb-4">Paramétrage de votre navigateur internet</h3>
            <p>
            ...
            <h2 className="text-2xl font-title font-semibold text-blue-ink mt-12 mb-4">Plus d'informations sur les cookies</h2>
            <p>
