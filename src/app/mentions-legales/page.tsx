...
export const metadata: Metadata = {
  ...
  description: 'Mentions légales du site Laurent Serre Développement - Informations sur l\'éditeur, l\'hébergeur et les conditions d\'utilisation.',
  robots: {
    index: true,
    follow: true,
  },
    ...
    <main className="bg-primary-bg text-gray-dark py-24 sm:py-32">
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <div className="space-y-10 font-body text-lg leading-8 text-gray-700">
          ...
          <div className="p-8 border border-gray-200 rounded-2xl bg-white shadow-sm">
            <h2 className="text-2xl font-title font-bold text-blue-ink mb-4">2. Directeur de la publication</h2>
            <p>Laurent Serre, Cofondateur & Président.</p>
          </div>

          <div className="p-8 border border-gray-200 rounded-2xl bg-white shadow-sm">
            <h2 className="text-2xl font-title font-bold text-blue-ink mb-4">3. Hébergeur</h2>
            <p>Vercel, Inc.</p>
            ...
            <table className="w-full my-4 border-collapse border border-gray-300">
              <thead>
                <tr>
                  ...
                  <th className="border border-gray-300 p-2 text-left">Base légale</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border border-gray-300 p-2">Gestion des demandes de contact</td>
                  <td className="border border-gray-300 p-2">3 ans</td>
                  <td className="border border-gray-300 p-2">Consentement</td>
                </tr>
                <tr>
                  <td className="border border-gray-300 p-2">Envoi de la newsletter</td>
                  <td className="border border-gray-300 p-2">Jusqu'au retrait</td>
                  <td className="border border-gray-300 p-2">Consentement</td>
                </tr>
              </tbody>
            </table>
          ...
          <div className="p-8 border border-gray-200 rounded-2xl bg-white shadow-sm">
            <h2 className="text-2xl font-title font-bold text-blue-ink mb-4">6. Cookies & traceurs</h2>
            <p>
          ...
          <div className="p-8 border border-gray-200 rounded-2xl bg-white shadow-sm">
            <h2 className="text-2xl font-title font-bold text-blue-ink mb-4">7. Responsabilité</h2>
            <p>
              Laurent Serre Développement s'efforce d'assurer l'exactitude des informations diffusées sur ce site,
              mais ne peut garantir qu'elles soient exemptes d'erreurs. L'entreprise décline toute responsabilité
              quant aux dommages directs ou indirects résultant de l'utilisation des informations présentes sur le site.
            </p>
          </div>

          <div className="p-8 border border-gray-200 rounded-2xl bg-white shadow-sm">
            <h2 className="text-2xl font-title font-bold text-blue-ink mb-4">8. Droit applicable</h2>
            <p>
