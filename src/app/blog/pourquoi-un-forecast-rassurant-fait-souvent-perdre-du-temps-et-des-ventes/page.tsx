...
export default function PourquoiUnForecastRassurantFaitSouventPerdreDuTempsEtDesVentesPage() {
  ...
  "@graph": [
    ...
    },
    {
      ...
      {
        '@type': 'FAQPage',
        '@id': 'https://www.laurentserre.com/blog/pourquoi-un-forecast-rassurant-fait-souvent-perdre-du-temps-et-des-ventes#faq',
        mainEntity: [
          {
            '@type': 'Question',
  ...
  
      {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Prévisions commerciales', 'item': 'https://www.laurentserre.com/blog/pourquoi-un-forecast-rassurant-fait-souvent-perdre-du-temps-et-des-ventes' },
        ],
      }
],
};
