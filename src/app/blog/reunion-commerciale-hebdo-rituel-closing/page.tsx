    ...
    ,
      {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Réunion commerciale hebdo', 'item': 'https://www.laurentserre.com/blog/reunion-commerciale-hebdo-rituel-closing' },
        ],
      }
]
  };
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-blue-ink/5 border border-blue-ink/10 rounded-2xl p-6 my-10">
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li><Link href="/blog/fatigue-commercial-terrain-rythme-performance" className="text-mint-green hover:underline font-medium">Fatigue du commercial terrain</Link> — Comment tenir la distance sans s'épuiser.</li>
              </ul>
