          ...
          <div className="bg-gradient-to-br from-amber-50 to-amber-100/50 border border-amber-200/60 rounded-2xl p-6 mt-10 mb-6">
            ...
            <BDCarousel
              images={[
                ...
                { src: '/images/blog/vente-perdue-avant-non/bd-slide-05-sans-urgence.webp', alt: 'Pas d urgence créée, la proposition traîne', index: 4 },
                ...
                { src: '/images/blog/vente-perdue-avant-non/bd-slide-07-laurent-observe.webp', alt: 'Laurent aide Marc à voir ce qu il a manqué', index: 6 },
                { src: '/images/blog/vente-perdue-avant-non/bd-slide-08-nouvelle-affaire.webp', alt: 'Marc applique la rigueur sur une nouvelle affaire', index: 7 },
                { src: '/images/blog/vente-perdue-avant-non/bd-slide-09-questions-justes.webp', alt: 'Il pose les bonnes questions cette fois', index: 8 },
                { src: '/images/blog/vente-perdue-avant-non/bd-slide-10-il-ne-gagne-pas-tout.webp', alt: 'Marc ne gagne pas tout, mais il voit clair', index: 9 },
