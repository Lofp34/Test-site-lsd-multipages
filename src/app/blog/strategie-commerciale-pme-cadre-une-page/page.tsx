...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://www.laurentserre.com/images/blog/2026-05-14-strategie-commerciale-pme-cadre-hero.png',
        width: 1264,
        height: 848,
  ...
  twitter: {
    ...
    description:
      'Un cadre qui tient sur une page vaut mieux que 47 slides que personne ne relit. Quatre questions, dans l\'ordre, pour choisir ce qui compte vraiment.',
    images: ['https://www.laurentserre.com/images/blog/2026-05-14-strategie-commerciale-pme-cadre-hero.png'],
  },
};
    ...
    '@graph': [
      {
        ...
        description:
          '47 slides, budget, SWOT, objectifs à 3 ans. Puis quatre questions qu\'il ne peut pas honorer. Le vrai problème des PME n\'est pas l\'absence de stratégie : c\'est l\'incapacité à choisir.',
        image: 'https://www.laurentserre.com/images/blog/2026-05-14-strategie-commerciale-pme-cadre-hero.png',
    ...
    <main>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        ...
        <div className="relative w-full aspect-video mb-10 rounded-2xl overflow-hidden shadow-lg">
          <Image
            src="/images/blog/2026-05-14-strategie-commerciale-pme-cadre-hero.png"
            alt="Stratégie commerciale PME — un cadre qui tient sur une page"
            fill
        ...
        <div className="mt-8 p-6 bg-blue-ink/5 rounded-xl border border-blue-ink/10">
          ...
          <p className="text-gray-700 leading-relaxed">
            Le vrai problème des PME n'est pas l'absence de stratégie. C'est l'incapacité à choisir.
            Un cadre simple de quatre questions — cible, différenciation, canal, volume — vaut mieux
            que 47 slides de plan stratégique que personne ne relit.
          </p>
        </div>
