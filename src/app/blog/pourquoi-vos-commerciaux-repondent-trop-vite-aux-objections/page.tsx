    ...
    },
    {
  ...
  
      {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Objections commerciales', 'item': 'https://www.laurentserre.com/blog/pourquoi-vos-commerciaux-repondent-trop-vite-aux-objections' },
        ],
      }
],
};
