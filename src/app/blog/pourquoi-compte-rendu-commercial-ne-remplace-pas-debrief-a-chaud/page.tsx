    ...
    },
    {
  ...
  
      {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Pourquoi le compte rendu commercial ne remplace…', 'item': 'https://www.laurentserre.com/blog/pourquoi-compte-rendu-commercial-ne-remplace-pas-debrief-a-chaud' },
        ],
      }
],
};
