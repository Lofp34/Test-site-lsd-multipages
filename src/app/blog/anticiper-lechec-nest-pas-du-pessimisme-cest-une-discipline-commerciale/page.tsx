    ...
    },
    {
  ...
  
      {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Anticiper l’échec n’est pas du pessimisme, c’est…', 'item': 'https://www.laurentserre.com/blog/anticiper-lechec-nest-pas-du-pessimisme-cest-une-discipline-commerciale' },
        ],
      }
],
};
