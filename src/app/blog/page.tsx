...
const blogPosts = [
  ...
  {
    slug: 'recrutement-commercial-senior-pme-7-signaux-alerte',
    title: 'Recruter un commercial senior en PME : 7 signaux d\'alerte à ne pas manquer',
    description: 'Un mauvais recrutement senior coûte 150 000€ à une PME. Les 7 signaux d\'alerte et les 3 questions qui révèlent un faux profil senior.',
    date: '2026-06-29',
    readTime: '7 min',
    category: 'Recrutement / Management',
    image: '/images/blog/recrutement-commercial-senior-pme-7-signaux-alerte/hero.webp',
    featured: true,
  },
  {
    slug: 'signaux-faibles-churn-b2b-pme',
    title: 'Signaux faibles churn B2B : les 7 alertes avant qu\'un client parte',
    description: 'Le client ne prévient pas avant de partir. Il envoie des signaux. Les 7 signaux faibles à détecter et le protocole de revue trimestrielle anti-churn.',
    date: '2026-06-29',
    readTime: '7 min',
    category: 'Stratégie client / Customer Success',
    image: '/images/blog/signaux-faibles-churn-b2b-pme/hero.webp',
    featured: true,
  },
  {
    slug: 'dirigeant-pme-reprend-vente-terrain-sans-casser-equipe',
    title: 'Le dirigeant PME qui reprend la vente en main (sans casser son équipe)',
    description: '3 moments où le dirigeant DOIT intervenir sur un deal, 3 où il ne le doit SURTOUT pas, et comment le faire sans démotiver son équipe.',
    date: '2026-06-29',
    readTime: '7 min',
    category: 'Management / Dirigeant',
    image: '/images/blog/dirigeant-pme-reprend-vente-terrain-sans-casser-equipe/hero.webp',
    featured: true,
  },
  {
    slug: 'experience-client-post-vente-ambassadeur-pme',
    title: 'Expérience client post-vente : transformer vos clients en ambassadeurs',
    description: '5 actions concrètes dans les 90 jours post-signature pour transformer un client satisfait en ambassadeur. Le programme adapté aux PME.',
    date: '2026-06-29',
    readTime: '6 min',
    category: 'Customer Success / Rétention',
    image: '/images/blog/experience-client-post-vente-ambassadeur-pme/hero.webp',
    featured: true,
  },
  {
    slug: 'pacte-commercial-pratique-3-promesses-aligner',
    title: 'Le pacte commercial en pratique : les 3 promesses à aligner en une réunion',
    description: 'La méthode opérationnelle pour aligner les trois promesses : dirigeant, commercial, client. Le point de vérité en 20 minutes par deal.',
    date: '2026-06-29',
    readTime: '5 min',
    category: 'Vente B2B / Méthode',
    image: '/images/blog/pacte-commercial-pratique-3-promesses-aligner/hero.webp',
    featured: true,
  },
  {
