    ...
    },
    {
  ...
  
      {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Les erreurs d’onboarding commercial qui vont…', 'item': 'https://www.laurentserre.com/blog/les-erreurs-onboarding-commercial-qui-plombent-performance-nouveau' },
        ],
      }
],
};
