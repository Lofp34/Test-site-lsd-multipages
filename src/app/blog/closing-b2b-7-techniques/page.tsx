        ...
        <div className="prose prose-lg max-w-none">
          ...
          <nav className="bg-blue-ink/5 border border-blue-ink/10 rounded-2xl p-6 mb-8 not-prose" aria-label="Sommaire">
            ...
            <ol className="space-y-1.5 text-sm">
              <li><a href="#fondamentaux" className="text-blue-ink hover:text-mint-green transition-colors">1. Les fondamentaux</a></li>
              <li><a href="#7-techniques" className="text-blue-ink hover:text-mint-green transition-colors">2. Les 7 techniques (fiches actionnables)</a></li>
              <li><a href="#scripts" className="text-blue-ink hover:text-mint-green transition-colors">3. Scripts prêts à l&apos;emploi</a></li>
              <li><a href="#mesurer" className="text-blue-ink hover:text-mint-green transition-colors">4. Mesurer &amp; piloter</a></li>
              <li><a href="#mini-cas" className="text-blue-ink hover:text-mint-green transition-colors">5. Mini-cas (anonymisé)</a></li>
              <li><a href="#faq" className="text-blue-ink hover:text-mint-green transition-colors">6. FAQ</a></li>
            </ol>
          </nav>

          <h2 id="fondamentaux" className="text-3xl font-title font-bold text-blue-ink mt-12 mb-6">Les fondamentaux</h2>
          ...
          <h2 id="7-techniques" className="text-3xl font-title font-bold text-blue-ink mt-12 mb-2">Les 7 techniques (fiches actionnables)</h2>
          ...
          <h2 id="scripts" className="text-3xl font-title font-bold text-blue-ink mt-12 mb-6">Scripts prêts à l'emploi (5 extraits)</h2>
...
Laurent
          ...
          <h2 id="mesurer" className="text-3xl font-title font-bold text-blue-ink mt-12 mb-6">Mesurer & piloter</h2>
          ...
          <h2 id="mini-cas" className="text-3xl font-title font-bold text-blue-ink mt-12 mb-6">Mini-cas (anonymisé)</h2>
          ...
          <h2 id="faq" className="text-3xl font-title font-bold text-blue-ink mt-12 mb-6">FAQ</h2>
