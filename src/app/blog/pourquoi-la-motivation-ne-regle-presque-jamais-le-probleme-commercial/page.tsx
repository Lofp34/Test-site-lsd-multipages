    ...
    },
    {
  ...
  
      {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Le vrai problème de votre équipe n’est presque…', 'item': 'https://www.laurentserre.com/blog/pourquoi-la-motivation-ne-regle-presque-jamais-le-probleme-commercial' },
        ],
      }
],
};
