        ...
        <div className="prose prose-gray max-w-none">
          ...
          <div className="bg-blue-ink/5 border border-blue-ink/10 rounded-2xl p-6 my-10">
            ...
            <ul className="space-y-3 text-sm text-gray-700">
              <li><Link href="/blog/developpement-commercial-pme-plan-action-5-etapes" className="text-mint-green hover:underline font-medium">Plan d'action développement commercial</Link></li>
              <li><Link href="/blog/strategie-commerciale-pme-cadre-une-page" className="text-mint-green hover:underline font-medium">Stratégie commerciale : le cadre en une page</Link></li>
              <li><Link href="/blog/developpement-commercial-pme-causes-racines" className="text-mint-green hover:underline font-medium">Les causes racines du développement commercial</Link></li>
            </ul>
          </div>
