...
const carouselImages = [
  ...
  { src: `${carouselPrefix}/bd-slide-02-moment1.webp`, alt: 'Le commercial est bloqué sur un deal à 80K, le dirigeant client ne veut parler qu au dirigeant', index: 1 },
  { src: `${carouselPrefix}/bd-slide-03-moment2.webp`, alt: 'Le dirigeant reprend un deal mal qualifié par son commercial', index: 2 },
  { src: `${carouselPrefix}/bd-slide-04-moment3.webp`, alt: 'En phase de closing, le dirigeant pèse de son autorité pour faire signer', index: 3 },
  { src: `${carouselPrefix}/bd-slide-05-nepas.webp`, alt: 'Les 3 moments où le dirigeant ne doit surtout pas intervenir', index: 4 },
  { src: `${carouselPrefix}/bd-slide-06-sanscasser.webp`, alt: 'Comment intervenir sans casser la motivation du commercial', index: 5 },
  { src: `${carouselPrefix}/bd-slide-07-lecon.webp`, alt: 'Leçon : ne remplace pas ton commercial, appuie-le', index: 6 },
  { src: `${carouselPrefix}/bd-slide-08-cta.webp`, alt: 'CTA : Diagnostic offert sur laurentserre.com', index: 7 },
];
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-gradient-to-br from-amber-50 to-amber-100/50 border border-amber-200/60 rounded-2xl p-6 mt-10 mb-6">
            ...
            <div className="mt-4 text-center">
              <Link
                href="/downloads/carrousel-dirigeant-reprend-vente.pdf"
