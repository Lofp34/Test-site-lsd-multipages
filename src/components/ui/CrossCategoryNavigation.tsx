  ...
  return (
    <div className="bg-white/70 rounded-2xl shadow-2xl p-8 border border-[var(--theme-primary)]/20 backdrop-blur-sm">
      <div className="text-center mb-8">
        ...
        <h3 className={`text-2xl font-bold text-blue-ink[${currentTheme.primaryColor}] mb-4`}>
        ...
        {suggestions.map((suggestion, index) => (
          <AnimatedSection key={suggestion.slug} delay={100 + index * 100}>
            <Link 
              ...
              className="group block p-6 bg-gradient-to-br from-white/50 to-white/30 rounded-xl border border-gray-200/50 hover:border-[var(--theme-primary)]/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
            >
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 group-hover:text-[var(--theme-primary)] transition-colors">
                      {suggestion.title}
                    </h4>
                  </div>
                </div>
      ...
      <div className="mt-8 text-center">
        <Link 
          ...
          className="inline-flex items-center gap-2 text-gray-600 hover:text-[var(--theme-primary)] transition-colors"
        >
