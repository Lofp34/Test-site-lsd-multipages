...
const CaseStudyGrid: React.FC<CaseStudyGridProps> = ({
  ...
  return (
    <div className="max-w-6xl mx-auto mb-12 px-4">
      <div className="bg-white/70 rounded-2xl shadow-2xl p-8 border border-gray-200/50 backdrop-blur-sm">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {caseStudies.map((caseStudy, index) => (
            <div 
              key={index}
              className="p-6 bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200/50 hover:shadow-lg transition-all duration-300"
            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h5 className="font-semibold text-blue-600 text-sm mb-2">
                ...
                {caseStudy.metrics && (
                  <div className="grid grid-cols-2 gap-2 pt-2 border-t border-gray-200/50">
                    <div className="text-center p-2 bg-red-50 rounded">
                      <div className="text-xs text-red-600 font-medium">Avant</div>
                      <div className="text-xs text-gray-700">{caseStudy.metrics.before}</div>
                    </div>
                    <div className="text-center p-2 bg-green-50 rounded">
                      <div className="text-xs text-green-600 font-medium">Après</div>
                      <div className="text-xs text-gray-700">{caseStudy.metrics.after}</div>
                    </div>
                  </div>
                )}
              </div>
        ...
        <div className="mt-8 p-6 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl border border-orange-200/50">
          <div className="flex items-center gap-3 mb-4">
            <div 
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-4">
            ...
            <div className="text-center p-3 bg-white/50 rounded-lg">
              ...
              <div className="text-xs text-gray-600">ROI moyen sur l'investissement mindset</div>
            </div>
            <div className="text-center p-3 bg-white/50 rounded-lg">
