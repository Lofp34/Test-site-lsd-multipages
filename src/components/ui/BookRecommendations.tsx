...
function BookSuggestionCard({ suggestion }: { suggestion: CrossCategorySuggestion }) {
  ...
  return (
    <div className="bg-white/80 rounded-xl border border-purple-200/30 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
      {/* Book Link */}
      <Link href={bookHref} className="block p-6 hover:bg-purple-50/50:bg-purple-900/20 transition-colors">
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            ...
            <Link 
              href={categoryHref}
              className="inline-flex items-center text-xs bg-purple-100 text-purple-700 px-2 py-1 rounded-full hover:bg-purple-200:bg-purple-900/50 transition-colors"
            >
