...
const MethodValuesSection = () => {
  ...
  return (
    <section className="py-16 bg-bg-main dark:bg-blue-ink">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold font-title text-primary-title dark:text-primary-bg mb-4">
            Ma méthode : Pragmatisme, Data & Terrain
          </h2>
          <p className="text-lg font-body text-primary-secondary dark:text-primary-bg/80 leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <blockquote className="mt-6 border-l-4 border-mint-green pl-4 italic">
              <p className="text-xl md:text-2xl font-italic text-primary-secondary dark:text-primary-bg/80 leading-relaxed">
        ...
        <div className="text-center mt-16">
          <p className="font-body text-primary-secondary dark:text-primary-bg/80 mb-6">
